...
#Defining Fixtures --> functions before test function --> ensure single_prediction
...
def test_single_pred_str_type(single_prediction): # data type is string or not
    assert isinstance(single_prediction.get('prediction')[0],str)

def test_single_pred_validate(single_prediction): # Accpets only Y
